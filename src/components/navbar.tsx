...
import { Box, ScaleFade, Slide, useDisclosure } from "@chakra-ui/react";
...
function Navbar() {
  ...
  return (
    <div className="h-20 bg-[#051927] bg-opacity-50 w-full flex items-center justify-between px-5 md:px-20 text-white font-normal z-50 relative">
      ...
      >
        <div className="h-full flex ">
          ...
          <div className="w-full bg-black/50 h-full" onClick={onToggle}></div>
        </div>
      </div>
